...
public:
    int divide(int dividend, int divisor) {
        //Refer this-https://leetcode.com/problems/divide-two-integers/discuss/1516367/Complete-Thinking-Process-or-Intuitive-Explanation-or-All-rules-followed-or-C%2B%2B-code
        if(dividend == divisor)
            return 1;
