//Another unstudied topic Q. I can't do it as of now. LC is really behind my back to study unstudied topics. Will start doing questions on it. For now just copying someone else's code for the sake of streak.
class Solution {
public:
