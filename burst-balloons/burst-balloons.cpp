//Looks like a Knapsack problem.
// Edit: But isn't. It apparently uses Matrix Chain Multiplication which I haven't studied yet. Will get back to this problem later and will copy someone's code just for the sake of maintaining a streak. 
class Solution {
public:
    int n;
